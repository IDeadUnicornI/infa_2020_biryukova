...
class game():
    def __init__(self, bullet, balls, t1, t2, gun1):
        self.bullet = bullet
        self.balls = balls
        ...
        while self.t1.live and self.t2.live or balls:
            for b in balls:
                ...
                if b.hittest(self.t1) and self.t1.live:
                    ...
                    canv.itemconfig(
                        self.screen, text='Позитивная энергия возросла на : ' + str(11 - self.gun1.bullet))
                    ...
                    canv.bind('<ButtonRelease-1>', '')
                    canv.itemconfig(
                        self.screen, text='Негативная энергия возросла на : ' + str(self.gun1.bullet))
...
game = game(balls=balls, bullet=bullet, gun1=g1, t1=t1, t2=t2)
